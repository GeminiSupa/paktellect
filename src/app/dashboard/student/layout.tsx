...
import { LayoutDashboard, Settings, CreditCard, Scale, BookOpen, Handshake, BookMarked, MessageSquare } from "lucide-react"
        ...
        <aside className="w-full md:w-80 shrink-0">
          <nav className="bg-secondary text-white rounded-[2.5rem] p-8 sticky top-32 shadow-2xl shadow-slate-900/20">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/dashboard/student/messages" className="flex items-center gap-4 px-5 py-4 rounded-2xl text-slate-200 hover:text-white hover:bg-white/5 transition-all duration-300 font-bold group">
                  <div className="size-10 rounded-xl bg-slate-800 flex items-center justify-center group-hover:bg-primary transition-colors shadow-lg">
