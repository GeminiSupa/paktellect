    ...
    <footer className="bg-white dark:bg-slate-900 border-t py-24">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h4 className="font-black uppercase tracking-widest text-[10px] text-slate-500 dark:text-slate-300 mb-6">Platform</h4>
          ...
          <div>
            <h4 className="font-black uppercase tracking-widest text-[10px] text-slate-500 dark:text-slate-300 mb-6">Connect</h4>
            <ul className="space-y-4 text-sm font-bold text-slate-700 dark:text-slate-200">
              <li><Link href="/help" className="hover:text-primary transition-colors">Contact Us</Link></li>
            </ul>
          </div>
        </div>
        <div className="pt-12 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-300">
